...
const translations = {
  pt: {
    ...
    testimonial1: '"O bolo ficou ainda mais lindo do que eu imaginava, e o sabor surpreendeu todo mundo!"',
    testimonial2: '"Atenção aos detalhes impressionante. Recomendo de olhos fechados."',
    testimonial3: '"Entrega no prazo e um cuidado enorme com o tema da festa. Virei cliente fiel!"',
    testimonial_cite: '— Cliente',
  ...
  en: {
    ...
    testimonial1: '"The cake was even more beautiful than I imagined, and the flavour surprised everyone!"',
    testimonial2: '"Impressive attention to detail. I recommend it with my eyes closed."',
    testimonial3: '"Delivered on time with amazing care for the party theme. I\'m a loyal customer now!"',
    testimonial_cite: '— Client',
